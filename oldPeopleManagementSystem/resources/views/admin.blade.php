...
<head>
    ...
    <header style="display: block; margin-top: 20px;">
        <a href="make_appointment" class="bg-primary-subtle text-black" style="border-radius: 10px; border: solid; border-color: black; text-align: center; width: 10%; padding: 0.1%; margin-top: 1%; margin-left: 1%; text-decoration: none;">Schedule appointments for patients</a>
