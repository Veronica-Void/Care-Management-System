...
<body>
    ...
    <form action="<?php echo e(route('additional-patient-info.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <table>
            <thead>
                <th>Patient ID</th>
...
</html><?php /**PATH C:\Users\vlvoid221\Desktop\Care-Management-System\oldPeopleManagementSystem\resources\views/additional-patient-info.blade.php ENDPATH**/ ?>